...
public class UserRemoteDataSource implements UserDataSource {
    ...
    @Override
    public Observable<GetStarredReposQuery.Data> getStarredRepos(@NonNull String login, @Nullable String pageCursor) {
        ApolloCall<GetStarredReposQuery.Data> apolloCall = ApolloProvider.getApolloInstance()
                .query(GetStarredReposQuery.builder()
                        .login(login)
                        .pageCursor(pageCursor)
                        .build());
        return Rx2Apollo.from(apolloCall)
